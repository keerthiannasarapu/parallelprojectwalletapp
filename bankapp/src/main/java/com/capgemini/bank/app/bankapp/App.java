package com.capgemini.bank.app.bankapp;
...
import com.capgemini.bankapp.exception.ErrorMessage;
...
public class App {
	...
	public static void testLogin() {
		...
		try {
			...
			if (username1.equals(pojocust.getUsername()) && password1.equals(pojocust.getPassword())) {
